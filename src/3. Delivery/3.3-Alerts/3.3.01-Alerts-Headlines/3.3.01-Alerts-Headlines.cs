...
namespace _3._3._01_Alerts_Headlines
{
    // **********************************************************************************************************************
    ...
    // The following example demonstrates how to manage (retrieve/create) queues within the cloud and to poll the queue
    // for messages. When polling stops, the user is presented
    ...
    class Program
    {
        ...
        static void DisplayHeadline(JToken msg)
        {
            try
            {
                var local = DateTime.Parse(msg["sourceTimestamp"].ToString()).ToLocalTime();
