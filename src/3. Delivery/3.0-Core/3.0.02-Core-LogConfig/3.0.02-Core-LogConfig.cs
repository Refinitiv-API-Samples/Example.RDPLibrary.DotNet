...
namespace _3._0._02_LogConfig
{
    ...
    //
    //      - Application logging
    //        In addition to configuring logging within the Refinitiv Data Platform library for .NET, applications can piggyback off of the 
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            System.Console.WriteLine("\nRefer to the output directory for the 2 log files generated.");
        }
    }
}
